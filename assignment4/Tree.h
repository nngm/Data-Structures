...
class Tree_t {
    ...
    public:
        ...
        void rotate(Node_t<keyT, valT>* n, bool direction) {
            if (direction) {
                assert(n->left);
                Node_t<keyT, valT> *p = n;
                Node_t<keyT, valT> *q = p->left;
                Node_t<keyT, valT> *r = p->right;
                Node_t<keyT, valT> *s = q->left;
                Node_t<keyT, valT> *t = q->right;
                ...
                if (n == root) {
                    ...
                    Node_t<keyT, valT> *parent = n->parent;
                    if (parent->left == n) {
                        parent->left = q;
                    }
                    else {
                ...
                assert(n->right);
                Node_t<keyT, valT> *q = n;
                Node_t<keyT, valT> *s = q->left;
                Node_t<keyT, valT> *p = q->right;
                Node_t<keyT, valT> *t = p->left;
                Node_t<keyT, valT> *r = p->right;
